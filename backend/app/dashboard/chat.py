...
# base.html calls branding() on every page — this env needs the global too, or
...
async def chat_completions(
    ...
    # Web search: if enabled, search and inject results into system message
    if body.get("web_search") and content:
        try:
            ...
            logger.warning("Web search injection failed, proceeding without", exc_info=True)
